...
// template void HashTable<int, int>::traverseWithCondition<std::string>(bool (*p)(const User&, std::string), 
//                                    void (*eff)(const int&), 
//                                    void (*ifnone)(),
//                                    std::string) const;
template Bucket<int>* deepCopyArr(Bucket<int>*, int);